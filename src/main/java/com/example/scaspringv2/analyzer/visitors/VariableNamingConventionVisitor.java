...
public class VariableNamingConventionVisitor extends AbstractVoidVisitorAdapter<Collector> {
    ...
    public void visit(ClassOrInterfaceDeclaration declaration, Collector collector) {
        ...
        collector.addAnalyzeResult("CAMEL_CASE_CLASS_NAME",
                new AnalyzeResult<>(className, isClassNameInCamelCase, CAMEL_CASE_CLASS_NAME, classNameInCamelCaseWarning));
    ...
    public void visit(MethodDeclaration declaration, Collector collector) {
        ...
        collector.addAnalyzeResult("METHOD_IN_CAMEL_CASE", new AnalyzeResult<>(className, isMethodInCamelCase, METHOD_IN_CAMEL_CASE, methodInCamelCaseWarnings));
        ...
        if (PARAM_IN_CAMEL_CASE) {
            for (Parameter param : declaration.getParameters()) {
                ...
                collector.addAnalyzeResult("PARAM_IN_CAMEL_CASE", new AnalyzeResult<>(className, isParamInCamelCase, PARAM_IN_CAMEL_CASE, paramInCamelCaseWarnings));
            }
        }
